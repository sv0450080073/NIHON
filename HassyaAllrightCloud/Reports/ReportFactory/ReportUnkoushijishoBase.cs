...
{
    public class ReportUnkoushijishoBase : ReportBase
    {
        public ReportUnkoushijishoBase(string reportName, string displayname)
        {
        ...
        public override Func<Dictionary<string, string>, XtraReport> CreateByParam
        {
            ...
            get
            {
                return (parameters) =>
                {
                    ...
                    var report = new UnkoushijishoBaseReport1A4();
    ...
    public class ReportUnkoushijishoBaseCreator : ReportCreator
    {
        private string _reportName;
        private string _displayName;
        public ReportUnkoushijishoBaseCreator(string reportName, string displayName)
        {
        ...
        {
            return new ReportUnkoushijishoBase(_reportName, _displayName);
        }
    }
}
