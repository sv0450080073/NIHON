...
{
    public class ReportJomukirokubo : ReportBase
    {
        public ReportJomukirokubo(string reportName, string displayname)
        {
        ...
        public override Func<Dictionary<string, string>, XtraReport> CreateByParam
        {
            ...
            get
            {
                return (parameters) =>
                {
                    ...
                    var report = new JomukirokuboReport1A4();
    ...
    public class ReportJomukirokuboCreator : ReportCreator
    {
        private string _reportName;
        private string _displayName;
        public ReportJomukirokuboCreator(string reportName, string displayName)
        {
        ...
        {
            return new ReportJomukirokubo(_reportName, _displayName);
        }
    }
}
