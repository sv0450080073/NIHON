...
/****** Object:  StoredProcedure [dbo].[RP_UnkoushijishoReport]    Script Date: 2021/04/29 14:05:24 ******/
SET ANSI_NULLS ON
GO
		...
		SELECT
			...
			FROM
							...
							LEFT JOIN
											...
											ON
															OTHJIN1.CodeKbn         = CONVERT(nvarchar(10), HAISHA.OthJinKbn1)
															And OTHJIN1.TenantCdSeq = 0 --ログインユーザーのテナントSeq
															AND OTHJIN1.CodeSyu     = 'OTHJINKBN'
							LEFT JOIN
											VPM_CodeKb AS OTHJIN2
											ON
															OTHJIN2.CodeKbn         = CONVERT(nvarchar(10), HAISHA.OthJinKbn2)
															AND OTHJIN2.TenantCdSeq = 0 --ログインユーザーのテナントSeq
