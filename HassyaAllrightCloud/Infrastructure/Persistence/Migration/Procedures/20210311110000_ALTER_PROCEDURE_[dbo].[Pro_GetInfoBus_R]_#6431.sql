...
/****** Object:  StoredProcedure [dbo].[Pro_GetInfoBus_R]    Script Date: 3/11/2021 8:20:56 AM ******/
SET ANSI_NULLS ON
GO
...
AS
	BEGIN TRY
		...
		SELECT @OrderCondition =		CASE
											WHEN @Order='1' 
												THEN ' ORDER BY EIGYOSHO.EigyoCdSeq ASC,
															   HAISHA.SyuKoYmd ASC,
		...
		IF(@Order ='5')
			BEGIN
				SELECT @OrderConditionRowNumber = ' ORDER BY EIGYOSHO.EigyoCdSeq ASC,
