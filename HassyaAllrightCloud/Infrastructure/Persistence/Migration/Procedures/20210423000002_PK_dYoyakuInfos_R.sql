USE [HOC_Kashikiri]
GO
/****** Object:  StoredProcedure [dbo].[PK_dYoyakuInfos_R]    Script Date: 4/23/2021 3:36:00 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE OR ALTER PROCEDURE [dbo].[PK_dYoyakuInfos_R]
...
BEGIN
	SELECT TKD_Shabni.UkeNo			
			...
			,ISNULL(JM_TokiSt.SitenNm, 0) AS SitenNm			
			,ISNULL(JM_TokiSk.TokuiNm, 0) AS TokuiNm			
