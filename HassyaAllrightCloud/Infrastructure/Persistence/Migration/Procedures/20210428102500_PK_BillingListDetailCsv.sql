USE [HOC_Kashikiri]
GO
/****** Object:  StoredProcedure [dbo].[PK_dBillingListDetailCsv_R]    Script Date: 4/28/2021 10:25:43 AM ******/
SET ANSI_NULLS ON
GO
...
------------------------------------------------------------
CREATE OR ALTER PROCEDURE [dbo].[PK_dBillingListDetailCsv_R]
		(
		--Parameter
			@BillDate				NVARCHAR(6),
			@CloseDate				TINYINT,
...
SELECT 
	...
	SUBSTRING(TKD_Mishum.UkeNo, 6, 11) AS UkeNo,
...
AND (@BillOffice IS NULL OR eVPM_Eigyos01.EigyoCd = @BillOffice)
