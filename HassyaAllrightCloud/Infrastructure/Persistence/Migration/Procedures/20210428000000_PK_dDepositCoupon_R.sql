USE [HOC_Kashikiri]
GO
/****** Object:  StoredProcedure [dbo].[PK_dDepositCoupon_R]    Script Date: 4/28/2021 8:22:45 AM ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN VPM_CodeKb AS eVPM_CodeKb011
 ...
 LEFT JOIN VPM_CodeKb AS eVPM_CodeKb012
	...
	AND eVPM_CodeKb012.TenantCdSeq = 0 -- ログインしたユーザーのTenantCdSeq
-- <税区分データ>
...
AND (@StartReservationClassification IS NULL 
...
AND (@EndReservationClassification IS NULL 
