USE [HOC_Kashikiri]
GO
/****** Object:  StoredProcedure [dbo].[PK_dBillingListGridWithOutputClassificationCsv_R]    Script Date: 1/20/2021 1:36:17 PM ******/
SET ANSI_NULLS ON
GO
...
------------------------------------------------------------
ALTER   PROCEDURE [dbo].[PK_dBillingListGridWithOutputClassificationCsv_R]
		(
		--Parameter
			@TenantCdSeq			INT,
			@BillDate				NVARCHAR(6),
...
SELECT
	...
	SUM(CAST(ISNULL(UriZenZan, 0) as bigint)) + SUM(CAST(ISNULL(GaiZenZan, 0) as bigint)) + SUM(CAST(ISNULL(EtcZenZan, 0) as bigint)) + SUM(CAST(ISNULL(EtcZenZan, 0) as bigint)) AS UGECZenZan,
	SUM(CAST(ISNULL(UriUriGakKin, 0) as bigint)) + SUM(CAST(ISNULL(GaiGaiGakKin, 0) as bigint)) + SUM(CAST(ISNULL(EtcEtcGakKin, 0) as bigint)) + SUM(CAST(ISNULL(CanCanGakKin, 0) as bigint)) AS UGECGakKin,
	SUM(CAST(ISNULL(UriSyaRyoSyo, 0) as bigint)) + SUM(CAST(ISNULL(GaiSyaRyoSyo, 0) as bigint)) + SUM(CAST(ISNULL(EtcSyaRyoSyo, 0) as bigint)) + SUM(CAST(ISNULL(CanSyaRyoSyo, 0) as bigint)) AS UGECSyaRyoSyo,
	SUM(CAST(ISNULL(UriSyaRyoTes, 0) as bigint)) + SUM(CAST(ISNULL(GaiSyaRyoTes, 0) as bigint)) + SUM(CAST(ISNULL(EtcSyaRyoTes, 0) as bigint)) + SUM(CAST(ISNULL(CanSyaRyoTes, 0) as bigint)) AS UGECSyaRyoTes,
	SUM(CAST(ISNULL(UriSeiKin, 0) as bigint)) + SUM(CAST(ISNULL(GaiSeiKin, 0) as bigint)) + SUM(CAST(ISNULL(EtcSeiKin, 0) as bigint)) + SUM(CAST(ISNULL(CanSeiKin, 0) as bigint)) AS UGECSeiKin,
	SUM(CAST(ISNULL(UriNyuKinRui, 0) as bigint)) + SUM(CAST(ISNULL(GaiNyuKinRui, 0) as bigint)) + SUM(CAST(ISNULL(EtcNyuKinRui, 0) as bigint)) + SUM(CAST(ISNULL(CanNyuKinRui, 0) as bigint)) AS UGECNyuKinRui,
	SUM(CAST((ISNULL(UriSeiKin, 0) +ISNULL(UriZenZan, 0) - ISNULL(UriNyuKinRui, 0)) as bigint)) + SUM(CAST((ISNULL(GaiSeiKin, 0) +ISNULL(GaiZenZan, 0) - ISNULL(GaiNyuKinRui, 0)) as bigint)) 
	+ SUM(CAST((ISNULL(EtcSeiKin, 0) +ISNULL(EtcZenZan, 0) - ISNULL(EtcNyuKinRui, 0)) as bigint)) + SUM(CAST((ISNULL(CanSeiKin, 0) +ISNULL(CanZenZan, 0) - ISNULL(CanNyuKinRui, 0)) as bigint)) AS UGECMisyuKin,
	SUM(CAST(ISNULL(UriMaeuke, 0) as bigint)) + SUM(CAST(ISNULL(GaiMaeuke, 0) as bigint)) + SUM(CAST(ISNULL(EtcMaeuke, 0) as bigint)) + SUM(CAST(ISNULL(CanMaeuke, 0) as bigint)) AS UGECMaeuke,
	SUM(CAST(ISNULL(UriZenZan, 0) as bigint)) + SUM(CAST(ISNULL(GaiZenZan, 0) as bigint)) + SUM(CAST(ISNULL(EtcZenZan, 0) as bigint)) AS UGCZenZan,
	SUM(CAST(ISNULL(UriUriGakKin, 0) as bigint)) + SUM(CAST(ISNULL(GaiGaiGakKin, 0) as bigint)) + SUM(CAST(ISNULL(CanCanGakKin, 0) as bigint)) AS UGCGakKin,
	SUM(CAST(ISNULL(UriSyaRyoSyo, 0) as bigint)) + SUM(CAST(ISNULL(GaiSyaRyoSyo, 0) as bigint)) + SUM(CAST(ISNULL(CanSyaRyoSyo, 0) as bigint)) AS UGCSyaRyoSyo,
	SUM(CAST(ISNULL(UriSyaRyoTes, 0) as bigint)) + SUM(CAST(ISNULL(GaiSyaRyoTes, 0) as bigint)) + SUM(CAST(ISNULL(CanSyaRyoTes, 0) as bigint)) AS UGCSyaRyoTes,
	SUM(CAST(ISNULL(UriSeiKin, 0) as bigint)) + SUM(CAST(ISNULL(GaiSeiKin, 0) as bigint)) + SUM(CAST(ISNULL(CanSeiKin, 0) as bigint)) AS UGCSeiKin,
	SUM(CAST(ISNULL(UriNyuKinRui, 0) as bigint)) + SUM(CAST(ISNULL(GaiNyuKinRui, 0) as bigint)) + SUM(CAST(ISNULL(CanNyuKinRui, 0) as bigint)) AS UGCNyuKinRui,
	SUM(CAST((ISNULL(UriSeiKin, 0) +ISNULL(UriZenZan, 0) - ISNULL(UriNyuKinRui, 0)) as bigint)) + SUM(CAST((ISNULL(GaiSeiKin, 0) +ISNULL(GaiZenZan, 0) - ISNULL(GaiNyuKinRui, 0)) as bigint)) 
	+ SUM(CAST((ISNULL(CanSeiKin, 0) +ISNULL(CanZenZan, 0) - ISNULL(CanNyuKinRui, 0)) as bigint)) AS UGCMisyuKin,
	SUM(CAST(ISNULL(UriMaeuke, 0) as bigint)) + SUM(CAST(ISNULL(GaiMaeuke, 0) as bigint)) + SUM(CAST(ISNULL(CanMaeuke, 0) as bigint)) AS UGCMaeuke
FROM (
