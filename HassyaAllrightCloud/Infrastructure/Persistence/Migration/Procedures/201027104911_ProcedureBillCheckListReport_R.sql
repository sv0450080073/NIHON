USE [HOC_Kashikiri]
GO
/****** Object:  StoredProcedure [dbo].[PK_dBillCheckListReport_R]    Script Date: 2020/10/27 10:45:17 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN (                                                                                                                                                                    
	...
	ON TKD_Mishum.UkeNo = eTKD_YykSyu.UkeNo                                                                                                                                     
	   WHERE eTKD_Yyksho01.TenantCdSeq = @TenantCdSeq
		...
		AND (@BillTypes IS NULL OR TKD_Mishum.SeiFutSyu IN (@BillTypes))																												-- チェックした各種別
		ORDER BY
