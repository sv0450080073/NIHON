...
/****** Object:  StoredProcedure [dbo].[Pro_VenderRequestMain_R]    Script Date: 11/2/2020 8:59:07 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

DROP PROCEDURE [dbo].[Pro_VenderRequestMain_R]

GO

CREATE   PROCEDURE [dbo].[Pro_VenderRequestMain_R]
		@minUkeCd varchar(10),
		@maxUkeCd varchar(10),
		@startDate varchar(8),
		@endDate varchar(8),
...
WHERE  
    ...
    AND YOUSHA.YouCdSeq BETWEEN @customerStart AND @customerEnd             --画面の傭車先																							
    AND YOUSHA.YouSitCdSeq BETWEEN @customerSirStart AND @customerSirEnd            --画面の傭車先支店
