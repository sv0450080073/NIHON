...
-- SP-ID		:   PK_dGetArrangementPlaceTypeList_R
-- DB-Name		:   HOC_Kashikiri
-- Name			:   Get List ArrangementPlaceType
-- Date			:   2021/05/18
-- Author		:   P.M.Nhat
-- Description	:   Get list ArrangementPlaceType with conditions
-- =============================================
CREATE OR ALTER PROCEDURE PK_dGetArrangementPlaceTypeList_R
...
BEGIN
	...
	WHERE eTPM_CodeKb1.CodeSyu = 'BUNRUICD'																								
