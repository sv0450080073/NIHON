/****** Object:  StoredProcedure [dbo].[PK_dAdvancePaymentDetailHeaderList_R]    Script Date: 2020/09/30 10:17:14 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER     PROCEDURE [dbo].[PK_dAdvancePaymentDetailHeaderList_R]
	(
			@TenantCdSeq		INT				-- テナントコード
		,	@ReceiptNumber		VARCHAR(15)		-- 受付番号
...
　　　　　AND eTKD_FutTum11.FutTumKbn = 1
　　　　　AND (@ReceiptNumber IS NULL OR @ReceiptNumber = '' OR eTKD_Yyksho11.UkeNo = (FORMAT(@TenantCdSeq, '00000') +  @ReceiptNumber))				-- 予約番号
