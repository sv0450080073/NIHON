USE [HOC_Kashikiri]
GO
/****** Object:  StoredProcedure [dbo].[PK_dBillingListGridWithoutOutputClassificationCsv_R]    Script Date: 1/20/2021 1:35:46 PM ******/
SET ANSI_NULLS ON
GO
...
------------------------------------------------------------
ALTER   PROCEDURE [dbo].[PK_dBillingListGridWithoutOutputClassificationCsv_R]
		(
		--Parameter
			@TenantCdSeq			INT,
			@BillDate				NVARCHAR(6),
