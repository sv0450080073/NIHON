...
BEGIN
	...
	    eTKD_Haisha.UpdYmd AS HaishaUpdYmd,
	    eTKD_Haisha.UpdTime AS HaishaUpdTime,
	    ISNULL(eTKD_Haiin.UpdYmd, '') AS HaiinUpdYmd,
	    ISNULL(eTKD_Haiin.UpdTime, '') AS HaiinUpdTime
	FROM				
	    (				
	        SELECT				
	            *				
