...
/****** Object:  StoredProcedure [dbo].[Pro_GetBusTypeList_R]    Script Date: 4/22/2021 10:38:03 AM ******/
SET ANSI_NULLS ON
GO
...
--  Comment     :
----------------------------------------------------
CREATE OR ALTER     PROCEDURE [dbo].[Pro_GetBusTypeList_R]
    (
	    @CompanyCdSeq int,
		@EigyoCdFrom int ,
		@EigyoCdTo int ,
