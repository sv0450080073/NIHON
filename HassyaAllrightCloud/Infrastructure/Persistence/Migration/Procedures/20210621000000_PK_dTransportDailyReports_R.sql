USE [HOC_Kashikiri]
GO
/****** Object:  StoredProcedure [dbo].[PK_dTransportDailyReports_R]    Script Date: 6/21/2021 8:11:30 AM ******/
SET ANSI_NULLS ON
GO
...
AS
BEGIN
    IF OBJECT_ID(N'tempdb..#VP_Haisha1') IS NOT NULL
	    BEGIN
        DROP TABLE #VP_Haisha1
    END

    IF OBJECT_ID(N'tempdb..#Tmp_Haiin') IS NOT NULL
        BEGIN
        DROP TABLE #Tmp_Haiin;
    END;
    SELECT
        TKD_Haiin.UkeNo
	    , TKD_Haiin.UnkRen
    ...
    CREATE NONCLUSTERED INDEX [<Name of Missing Index, sysname,>]
	    ON [dbo].[#VP_Haisha1] ([UkeNo],[UnkRen],[TeiDanNo],[BunkRen])
	    INCLUDE ([SyainCdSeq1],[SyainCdSeq2],[SyainCdSeq3],[SyainCdSeq4],[SyainCdSeq5])
    ...
    FROM TKD_Haisha AS eTKD_Haisha
        ...
        LEFT JOIN VPM_CodeKb AS eVPM_CodeKb02 ON eVPM_CodeKb02.CodeSyu = 'YOYAKBN'
            AND eVPM_CodeKb02.CodeKbn = CONVERT(INT, eTKD_YykSho.YoyaKbnSeq)
        ...
        LEFT JOIN VPM_Tokisk AS eVPM_Tokisk ON eTKD_YYksho.TokuiSeq = eVPM_Tokisk.TokuiSeq
			...
			AND eVPM_Tokisk.TenantCdSeq = @TenantCdSeq
        -- 得意先支店 																														
        ...
        LEFT JOIN VPM_Gyosya AS eVPM_Gyosya ON eVPM_Gyosya.GyosyaCdSeq = eVPM_Tokisk.GyosyaCdSeq
			AND eVPM_Gyosya.TenantCdSeq = @TenantCdSeq
        ...
        LEFT JOIN VPM_Syokum AS eVPM_Syokum01 ON eVPM_KyoSHe01.SyokumuCdSeq = eVPM_Syokum01.SyokumuCdSeq
			AND eVPM_Syokum01.TenantCdSeq = @TenantCdSeq
        -- 乗務員2 																														
        ...
        LEFT JOIN VPM_Syokum AS eVPM_Syokum02 ON eVPM_KyoSHe02.SyokumuCdSeq = eVPM_Syokum02.SyokumuCdSeq
			AND eVPM_Syokum02.TenantCdSeq = @TenantCdSeq
        -- 乗務員3 																														
        ...
        LEFT JOIN VPM_Syokum AS eVPM_Syokum03 ON eVPM_KyoSHe03.SyokumuCdSeq = eVPM_Syokum03.SyokumuCdSeq
			AND eVPM_Syokum03.TenantCdSeq = @TenantCdSeq
        -- 乗務員4 																														
        ...
        LEFT JOIN VPM_Syokum AS eVPM_Syokum04 ON eVPM_KyoSHe04.SyokumuCdSeq = eVPM_Syokum04.SyokumuCdSeq
			AND eVPM_Syokum04.TenantCdSeq = @TenantCdSeq
        -- 乗務員5 																														
