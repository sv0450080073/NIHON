USE [HOC_Kashikiri]
GO
/****** Object:  StoredProcedure [dbo].[PK_dVehicleDailyReportForEdit_R]    Script Date: 4/28/2021 10:48:11 AM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE OR ALTER PROCEDURE [dbo].[PK_dVehicleDailyReportForEdit_R]
(
	-- Parameter
		@UkeNo			nchar(15)	
	,	@UnkRen			smallint	
