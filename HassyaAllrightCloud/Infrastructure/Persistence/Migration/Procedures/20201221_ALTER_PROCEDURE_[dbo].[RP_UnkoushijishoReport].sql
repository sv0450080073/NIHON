...
/****** Object:  StoredProcedure [dbo].[RP_UnkoushijishoReport]    Script Date: 2020/11/18 14:16:00 ******/
SET ANSI_NULLS ON
GO
...
DROP PROCEDURE [dbo].[RP_UnkoushijishoReport]
        ...
        FROM
                        ...
                        LEFT JOIN
                                        ...
                                        ON
                                                        ...
                                                        And OTHJIN1.TenantCdSeq = @TenantCdSeq --ログインユーザーのテナントSeq
                                                        AND OTHJIN1.CodeSyu     = 'OTHJINKBN'
                        LEFT JOIN
                                        VPM_CodeKb AS OTHJIN2
                                        ON
                                                        OTHJIN2.CodeKbn         = CONVERT(varchar(10), HAISHA.OthJinKbn2)
                                                        AND OTHJIN2.TenantCdSeq = @TenantCdSeq --ログインユーザーのテナントSeq
