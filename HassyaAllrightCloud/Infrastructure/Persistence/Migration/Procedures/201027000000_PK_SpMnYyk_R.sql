USE [HOC_Kashikiri]
GO
/****** Object:  StoredProcedure [dbo].[PK_SpMnYyk_R]    Script Date: 10/27/2020 8:36:26 AM ******/
SET ANSI_NULLS ON
GO
...
ALTER   PROCEDURE [dbo].[PK_SpMnYyk_R]
	@TenantCdSeq int,
    @CompanyCdSeq int,
	...
	IF (@OffSet IS NULL)
		BEGIN
            ...
            WHERE
                ...
                AND (@StartReservationClassification IS NULL OR eVPM_YoyKbn01.YoyaKbn >= @StartReservationClassification) -- 予約区分
                AND (@EndReservationClassification IS NULL OR eVPM_YoyKbn01.YoyaKbn <= @EndReservationClassification) -- 予約区分
