...
/****** Object:  StoredProcedure [dbo].[Pro_GetKouteiAndTeHai_R]    Script Date: 2021/05/06 14:14:04 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [dbo].[Pro_GetKouteiAndTeHai_R]   
	@Ukeno NCHAR(15),
	@UnkRen SMALLINT,
	@SyuKoYmd CHAR(10),
	@KikYmd CHAR(10),
...
AS   
		...
		ORDER BY tbl.RowID
		DECLARE @tblsubreport TABLE(DateKotei DATE,Koutei NVARCHAR(102),TehNm NVARCHAR(102),TehTel CHAR(14),DateShow NVARCHAR(20),[ID] [int] IDENTITY(1,1) NOT NULL)
		WHILE (@i <= @totalRecords)
			BEGIN
				SELECT @date=datehaisha
				FROM #Datetmp
