USE [HOC_Kashikiri]
GO
/****** Object:  StoredProcedure [dbo].[PK_dAdvancePaymentDetailChildList_R]    Script Date: 06/10/2021 9:17:12 AM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	LEFT JOIN VPM_Seisan AS eVPM_Seisan11 
		...
		AND eVPM_Seisan11.TenantCdSeq = @TenantCdSeq -- ログインしたユーザーのTenantCdSeq 2021/05/28 ADD
