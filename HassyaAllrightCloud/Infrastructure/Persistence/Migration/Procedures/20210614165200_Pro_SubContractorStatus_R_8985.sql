USE [HOC_Kashikiri]
GO
/****** Object:  StoredProcedure [dbo].[Pro_SubContractorStatus_R]    Script Date: 17/06/2021 12:36:46 CH ******/
SET ANSI_NULLS ON
GO
...
SELECT ROW_NUMBER() OVER(ORDER BY (SELECT NULL)) AS 'RowNum', *
	...
	AND YOU_YOYKBN.TenantCdSeq = @tenantId                     --ログインユーザーのテナントコードSeq
	...
	WHERE
	 ...
	 AND YOU_YOYKBN.YoyaKbn >= @bookingTypeFrom
	 AND YOU_YOYKBN.YoyaKbn <= @bookingTypeTo
