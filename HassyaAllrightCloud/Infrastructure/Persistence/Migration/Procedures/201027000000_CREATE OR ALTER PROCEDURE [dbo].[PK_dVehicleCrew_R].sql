USE [HOC_Kashikiri]
GO
/****** Object:  StoredProcedure [dbo].[PK_dVehicleCrew_R]    Script Date: 2020/10/27 15:18:11 ******/
SET ANSI_NULLS ON
GO
...
WHERE
	...
	AND TKD_Yyksho.UkeNo + FORMAT(eTKD_Unkobi01.UnkRen, '00000') + FORMAT(eTKD_Haisha01.TeiDanNo, '00000') + FORMAT(eTKD_Haisha01.BunkRen, '00000') >= @StartFilterNo
	AND TKD_Yyksho.UkeNo + FORMAT(eTKD_Unkobi01.UnkRen, '00000') + FORMAT(eTKD_Haisha01.TeiDanNo, '00000') + FORMAT(eTKD_Haisha01.BunkRen, '00000') <= @EndFilterNo
