USE [HOC_Kashikiri]
GO
/****** Object:  StoredProcedure [dbo].[PK_dPaymentRequestPreview_R]    Script Date: 3/10/2021 10:53:44 AM ******/
SET ANSI_NULLS ON
GO
...
OR (ISNULL(@SeiOutSyKbn,1)	= 2
AND (@StaUkeNo = '' OR RIGHT(TKD_Mishum.UkeNo, 10) >= @StaUkeNo)
AND (@EndUkeNo = '' OR RIGHT(TKD_Mishum.UkeNo, 10) <= @EndUkeNo)
AND (@SeiEigCdSeq = 0 OR eTKD_Yyksho11.SeiEigCdSeq = @SeiEigCdSeq)) 
