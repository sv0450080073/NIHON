USE [HOC_Kashikiri]
GO
/****** Object:  StoredProcedure [dbo].[PK_dVehicleSum_R]    Script Date: 2021/05/18 8:15:14 ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN VPM_Basyo AS eVPM_Basyo03
	...
	AND eVPM_Basyo03.TenantCdSeq = @TenantCdSeq -- 2021/05/18 ADD
LEFT JOIN
	(
		SELECT UkeNo,
			BikoTblSeq,
...
LEFT JOIN VPM_Basyo AS eVPM_Basyo01
	ON eTKD_Unkobi01.HasMapCdSeq = eVPM_Basyo01.BasyoMapCdSeq
	   AND eVPM_Basyo01.TenantCdSeq = @TenantCdSeq -- 2021/05/18 ADD
...
LEFT JOIN VPM_Basyo AS eVPM_Basyo02
	...
	AND eVPM_Basyo02.TenantCdSeq = @TenantCdSeq -- 2021/05/18 ADD
...
LEFT JOIN VPM_Gyosya AS	eVPM_Gyosya04
	...
	AND eVPM_Tokisk02.TenantCdSeq = eVPM_Gyosya04.TenantCdSeq -- 2021/05/25 ADD
