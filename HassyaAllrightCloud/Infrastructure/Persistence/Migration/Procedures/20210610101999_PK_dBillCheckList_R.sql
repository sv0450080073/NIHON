...
AS 
	...
	LEFT JOIN  VPM_YoyKbn AS eVPM_YoyKbn01                                                                                                                                          
		ON  eTKD_Yyksho01.YoyaKbnSeq = eVPM_YoyKbn01.YoyaKbnSeq 
            AND eVPM_YoyKbn01.TenantCdSeq = @Loc_TenantCdSeq
	-- コード区分マスタ 請求区分                                                                                                                                                   
	...
	LEFT JOIN (                                                                                                                                                                    
	   ...
	   WHERE eTKD_Yyksho01.TenantCdSeq = @Loc_TenantCdSeq
		...
		AND (@Loc_StartReservationClassification IS NULL OR eVPM_YoyKbn01.YoyaKbn >= @Loc_StartReservationClassification)
		AND (@Loc_EndReservationClassification IS NULL OR eVPM_YoyKbn01.YoyaKbn <= @Loc_EndReservationClassification)
