USE [HOC_Kashikiri]
GO
/****** Object:  StoredProcedure [dbo].[Pro_GetDriverAndGuiList_R]    Script Date: 9/11/2020 9:24:16 AM ******/
SET ANSI_NULLS ON
GO
...
--  Comment     :
----------------------------------------------------
CREATE PROCEDURE [dbo].[Pro_GetDriverAndGuiList_R]
    (
		@Ukeno VARCHAR(20)
	,	@UnkRen VARCHAR(10)
	,	@TeiDanNo VARCHAR(10)
	...
	BEGIN TRY 	
		...
		FROM (
			...
			JOIN TKD_Haisha AS HAISHA 	
				...
				WHERE HAISHA.UkeNo  =' + ISNULL(@Ukeno,'0') + '
