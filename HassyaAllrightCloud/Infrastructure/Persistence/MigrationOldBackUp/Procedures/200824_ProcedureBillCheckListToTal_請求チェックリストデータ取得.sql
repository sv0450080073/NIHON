...
-- SP-ID		:   PK_dBillCheckListSum_R
-- DB-Name		:   HOC_Kashikiri
-- Name			:   Get data bill check list total table
-- Date			:   2020/08/26
-- Author		:   N.T.Lan.Anh
-- Description	:   Get data for bill check list total table with conditions
------------------------------------------------------------
CREATE OR ALTER  PROCEDURE [dbo].[PK_dBillCheckListSum_R]
	(
	-- Parameter
		    @TenantCdSeq int                                
		,	@CompanyCdSeq int 
...
SET @strSQL = @strSQL
+   CHAR(13)+CHAR(10)	+	' SELECT TKD_Mishum.SeiFutSyu,                                                                                                                                                           '
+   CHAR(13)+CHAR(10)	+	' SUM(TKD_Mishum.SeiKin) SeiKin,                                                                                                                                                                    '
+   CHAR(13)+CHAR(10)	+	' SUM(TKD_Mishum.NyuKinRui) NyuKinRui,                                                                                                                                              '
+   CHAR(13)+CHAR(10)	+	' SUM(TKD_Mishum.UriGakKin) UriGakKin,                                                                                               '
+   CHAR(13)+CHAR(10)	+	' SUM((TKD_Mishum.SeiKin - TKD_Mishum.NyuKinRui)) AS MisyuG,                                                                                                                                 '
+   CHAR(13)+CHAR(10)	+	' SUM(TKD_Mishum.SyaRyoSyo) SyaRyoSyo,                                                                                                                               '
+   CHAR(13)+CHAR(10)	+	' SUM(TKD_Mishum.SyaRyoTes) SyaRyoTes                                                                                                                                                                  '
...
+   CHAR(13)+CHAR(10)	+	'   WHERE  TKD_Mishum.SeiFutSyu >= 1 AND  TKD_Mishum.SeiFutSyu <= 7                                                                                                               '
+   CHAR(13)+CHAR(10)	+	    CONCAT('AND eTKD_Yyksho01.TenantCdSeq = ', @TenantCdSeq)   
...
END	
		...
		SET @strSQL = @strSQL
		+   CHAR(13)+CHAR(10)	+ ' GROUP BY TKD_Mishum.SeiFutSyu '
		+   CHAR(13)+CHAR(10)	+ ' order by TKD_Mishum.SeiFutSyu '
