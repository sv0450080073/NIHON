...
{
    public class TkdKobanConfiguration : IEntityTypeConfiguration<TkdKoban>
    {
        public void Configure(EntityTypeBuilder<TkdKoban> entity)
        {
            entity.HasKey(e => new { e.UnkYmd, e.SyainCdSeq, e.KouBnRen })
                .IsClustered(false);

            entity.ToTable("TKD_Koban");
