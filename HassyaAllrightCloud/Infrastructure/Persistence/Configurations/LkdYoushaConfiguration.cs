...
{
    public class LkdYoushaConfiguration : IEntityTypeConfiguration<LkdYousha>
    {
        public void Configure(EntityTypeBuilder<LkdYousha> entity)
        {
            entity.HasKey(e => e.LogSeq)
                .HasName("LKD_Yousha1");

            entity.ToTable("LKD_Yousha");
