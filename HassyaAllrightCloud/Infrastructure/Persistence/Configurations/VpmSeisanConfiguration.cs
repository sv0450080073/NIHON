...
{
    public class VpmSeisanConfiguration : IEntityTypeConfiguration<VpmSeisan>
    {
        public void Configure(EntityTypeBuilder<VpmSeisan> entity)
        {
            entity.HasNoKey();

            entity.ToView("VPM_Seisan");
            ...
            entity.Property(e => e.SeisanCdSeq).ValueGeneratedOnAdd();
