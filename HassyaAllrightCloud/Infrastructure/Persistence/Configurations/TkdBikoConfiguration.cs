...
{
    public class TkdBikoConfiguration : IEntityTypeConfiguration<TkdBiko>
    {
        public void Configure(EntityTypeBuilder<TkdBiko> entity)
        {
            entity.HasKey(e => new { e.UkeNo, e.BikoTblSeq, e.BikoRen })
                .HasName("TKD_Biko2")
                .IsClustered(false);

            entity.ToTable("TKD_Biko");
