...
{
    public class LkdShuYmdConfiguration : IEntityTypeConfiguration<LkdShuYmd>
    {
        public void Configure(EntityTypeBuilder<LkdShuYmd> entity)
        {
            entity.HasKey(e => e.LogSeq)
                .HasName("LKD_ShuYmd1");

            entity.ToTable("LKD_ShuYmd");
