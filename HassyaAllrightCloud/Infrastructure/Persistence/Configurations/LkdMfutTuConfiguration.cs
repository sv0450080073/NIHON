...
{
    public class LkdMfutTuConfiguration : IEntityTypeConfiguration<LkdMfutTu>
    {
        public void Configure(EntityTypeBuilder<LkdMfutTu> entity)
        {
            entity.HasKey(e => e.LogSeq)
                .HasName("LKD_MFutTu1");

            entity.ToTable("LKD_MFutTu");
