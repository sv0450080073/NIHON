...
{
    public class TkdKoteikConfiguration : IEntityTypeConfiguration<TkdKoteik>
    {
        public void Configure(EntityTypeBuilder<TkdKoteik> entity)
        {
            entity.HasKey(e => new { e.UkeNo, e.UnkRen, e.TeiDanNo, e.BunkRen, e.TomKbn, e.Nittei });

            entity.ToTable("TKD_Koteik");
