...
{
    public class LkdMihrimConfiguration : IEntityTypeConfiguration<LkdMihrim>
    {
        public void Configure(EntityTypeBuilder<LkdMihrim> entity)
        {
            entity.HasKey(e => e.LogSeq)
                .HasName("LKD_Mihrim1");

            entity.ToTable("LKD_Mihrim");
