...
{
    public class LkdYykReportConfiguration : IEntityTypeConfiguration<LkdYykReport>
    {
        public void Configure(EntityTypeBuilder<LkdYykReport> entity)
        {
            entity.HasKey(e => e.LogSeq)
                .HasName("LKD_YykReport1");

            entity.ToTable("LKD_YykReport");
