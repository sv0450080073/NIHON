...
{
    public class LkdJyoshaConfiguration : IEntityTypeConfiguration<LkdJyosha>
    {
        public void Configure(EntityTypeBuilder<LkdJyosha> entity)
        {
            entity.HasKey(e => e.LogSeq)
                .HasName("LKD_Jyosha1");

            entity.ToTable("LKD_Jyosha");
