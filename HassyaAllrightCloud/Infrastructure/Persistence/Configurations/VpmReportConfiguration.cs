...
{
    public class VpmReportConfiguration : IEntityTypeConfiguration<VpmReport>
    {
        public void Configure(EntityTypeBuilder<VpmReport> entity)
        {
            entity.HasNoKey();

            entity.ToView("VPM_Report");
