...
{
    public class TkdYykReportConfiguration : IEntityTypeConfiguration<TkdYykReport>
    {
        public void Configure(EntityTypeBuilder<TkdYykReport> entity)
        {
            entity.HasKey(e => new { e.UkeNo, e.UnkRen, e.SyaSyuRen });

            entity.ToTable("TKD_YykReport");
