...
{
    public class TkdYykReportMeiConfiguration : IEntityTypeConfiguration<TkdYykReportMei>
    {
        public void Configure(EntityTypeBuilder<TkdYykReportMei> entity)
        {
            entity.HasKey(e => new { e.UkeNo, e.UnkRen, e.SyaSyuRen, e.Nittei });

            entity.ToTable("TKD_YykReportMei");
