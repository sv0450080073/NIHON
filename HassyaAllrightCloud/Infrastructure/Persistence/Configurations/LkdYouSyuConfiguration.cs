...
{
    public class LkdYouSyuConfiguration : IEntityTypeConfiguration<LkdYouSyu>
    {
        public void Configure(EntityTypeBuilder<LkdYouSyu> entity)
        {
            entity.HasKey(e => e.LogSeq)
                .HasName("LKD_YouSyu1");

            entity.ToTable("LKD_YouSyu");
