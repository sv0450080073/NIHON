...
{
    public class VpmNotiTemplateConfiguration : IEntityTypeConfiguration<VpmNotiTemplate>
    {
        public void Configure(EntityTypeBuilder<VpmNotiTemplate> entity)
        {
            entity.HasNoKey();

            entity.ToView("VPM_NotiTemplate");
