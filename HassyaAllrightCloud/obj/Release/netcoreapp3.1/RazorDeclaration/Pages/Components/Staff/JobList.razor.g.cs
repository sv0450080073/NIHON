#pragma checksum "E:\Project\HassyaAllrightCloud\Pages\Components\Staff\JobList.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e020379080adb09193df1619569c13c4a28c41cb"
// <auto-generated/>
...
#line 14 "E:\Project\HassyaAllrightCloud\Pages\Components\Staff\JobList.razor"
    ...
    protected override void OnParametersSet()
    {
        if (Container.Params.WorkSort == (int)StaffWorkSortOrder.Earlier) {
            List = List.OrderBy(x => x.TimeStartString).ToList();
        }
        else if (Container.Params.WorkSort == (int)StaffWorkSortOrder.Time) {
            List = List.OrderByDescending(x => x.TimeEndString).ToList();
        }
    }

    private void HandleDragStart(JobData selectItem)
    {
        Container.Job = selectItem;
        Container.Payload.Status = Flag.Job;
