#pragma checksum "E:\Project\HassyaAllrightCloud\Pages\Components\BusLine.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d5b6717768dbf09485bb8b4b4bb5ee490bad7c28"
// <auto-generated/>
...
#nullable restore
#line 87 "E:\Project\HassyaAllrightCloud\Pages\Components\BusLine.razor"
    ...
    public async Task ActualFocusCell(double left,double width)
    {
        ...
        tmp.ShuriCdSeq = CodeKbnItem.CodeKb_CodeKbnSeq;
        tmp.AllowEdit = true;
        tmp.AllowDrop = true;
    ...
    private async Task HandleMouseDown(MouseEventArgs e,string LineId, ElementReference lineref)
    {
        if(LineType!=1&&LineType!=2 &&e.Buttons==1)
        {
            ...
            DateTime mindate = date.AddMinutes(15);
