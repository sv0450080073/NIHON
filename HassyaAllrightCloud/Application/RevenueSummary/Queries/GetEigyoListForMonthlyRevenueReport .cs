...
{
    public class GetEigyoListForMonthlyRevenueReport : IRequest<List<EigyoListItem>>
    {
        public TransportationRevenueSearchModel SearchModel { get; set; }
        public class Handler : IRequestHandler<GetEigyoListForMonthlyRevenueReport , List<EigyoListItem>>
        {
            ...
            /// <returns></returns>
            public async Task<List<EigyoListItem>> Handle(GetEigyoListForMonthlyRevenueReport  request, CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    command.CommandText = @$"EXECUTE PK_dEigyosForMonthlyRevenueReport_R
                                                @UriYmdFrom,
                                                @UriYmdTo,
                                                @CompanyCd,
                                                @EigyoCdFrom,
