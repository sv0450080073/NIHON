...
{
    public class GetBillingListDetailCsvAsyncQuery : IRequest<List<BillingListDetailGridCsvData>>
    {
        public BillingListFilter billingListFilter { get; set; }
        public class Handler : IRequestHandler<GetBillingListDetailCsvAsyncQuery, List<BillingListDetailGridCsvData>>
        {
            ...
            public async Task<List<BillingListDetailGridCsvData>> Handle(GetBillingListDetailCsvAsyncQuery request, CancellationToken cancellationToken = default)
            {
                if(request.billingListFilter == null)
                    return new List<BillingListDetailGridCsvData>();
                ...
                List<BillingListDetailGridCsvData> BillingListDetailGridCsvDatas = new List<BillingListDetailGridCsvData>();
                ...
                await _context.LoadStoredProc("PK_dBillingListDetailCsv_R")
                                ...
                                .ExecAsync(async r => BillingListDetailGridCsvDatas = await r.ToListAsync<BillingListDetailGridCsvData>());

                return BillingListDetailGridCsvDatas;
            }
        }
    }
}
