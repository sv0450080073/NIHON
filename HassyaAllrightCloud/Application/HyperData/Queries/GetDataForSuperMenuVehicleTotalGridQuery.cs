...
{
    public class GetDataForSuperMenuVehicleTotalGridQuery : IRequest<SuperMenuVehicleTotalGridData>
    {
        public HyperFormData hyperData { get; set; }
        public int companyId { get; set; }
        public int tenantId { get; set; }
        public class Handler : IRequestHandler<GetDataForSuperMenuVehicleTotalGridQuery, SuperMenuVehicleTotalGridData>
        {
            ...
            public async Task<SuperMenuVehicleTotalGridData> Handle(GetDataForSuperMenuVehicleTotalGridQuery request, CancellationToken cancellationToken)
            {
                SuperMenuVehicleTotalGridData totalGridData = new SuperMenuVehicleTotalGridData();
                using (var command = _dbContext.Database.GetDbConnection().CreateCommand())
                {
                    CreateParameter(command, "PK_dVehicleSum_R", request.hyperData, request.companyId, request.tenantId);
                    ...
                    if (totalRow.Read())
                    {
                        totalGridData = new SuperMenuVehicleTotalGridData()
                        {
                            ...
                            Company = new SuperMenuVehicleTotalData
                            {
                                ...
                                Other = (long)totalRow["CompanyOtherCharge"],
                                OtherTax = (long)totalRow["CompanyOtherChargeTax"],
                                OtherFee = (long)totalRow["CompanyOtherChargeCommission"]
                            },
                            Bus = new SuperMenuVehicleTotalData
                            {
                                ...
                                Other = (long)totalRow["YousyaOtherCharge"],
                                OtherTax = (long)totalRow["YousyaOtherChargeTax"],
                                OtherFee = (long)totalRow["YousyaOtherChargeCommission"]
                            }
                        };
                    }
                    totalRow.Close();
