...
{
    public class GetListAdvancePaymentDetailsChildQuery : IRequest<List<AdvancePaymentDetailsChildModel>>
    {
        public AdvancePaymentDetailsSearchParam SearchParams { get; set; }

        public class Handlers : IRequestHandler<GetListAdvancePaymentDetailsChildQuery, List<AdvancePaymentDetailsChildModel>>
        {
            ...
            public async Task<List<AdvancePaymentDetailsChildModel>> Handle(GetListAdvancePaymentDetailsChildQuery request, CancellationToken cancellationToken)
            {
                List<AdvancePaymentDetailsChildModel> listAdvancePaymentDetailsChild = new List<AdvancePaymentDetailsChildModel>();
                var storedBuilder = _context.LoadStoredProc("dbo.PK_dAdvancePaymentDetailChildList_R");
                ...
                await storedBuilder.ExecAsync(async rows => listAdvancePaymentDetailsChild = await rows.ToListAsync<AdvancePaymentDetailsChildModel>());
                return listAdvancePaymentDetailsChild;
            }
        }
    }
}
