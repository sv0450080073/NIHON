...
{
    public class GetCodeKbnCodeSyuDataQuery : IRequest<List<TPM_CodeKbCodeSyuData>>
    {
        ...
        public class Handler : IRequestHandler<GetCodeKbnCodeSyuDataQuery, List<TPM_CodeKbCodeSyuData>>
        {
            ...
            public async Task<List<TPM_CodeKbCodeSyuData>> Handle(GetCodeKbnCodeSyuDataQuery request, CancellationToken cancellationToken)
            {
