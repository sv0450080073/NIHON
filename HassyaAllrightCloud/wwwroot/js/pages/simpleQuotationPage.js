function enterKey(){
    $('#simpleQuotationForm input, .withtabindex').bind("keydown", function (e) {
        if (e.keyCode == 13) {
            const controls = $('#simpleQuotationForm .withtabindex').filter((index, curr) => !curr.readOnly && !curr.disabled);
