...
function pressEsc() {
    ...
    if (strLocation == "StaffsChart") {
        document.addEventListener('keydown', function (event) {
            if (event.key === "Escape") {
                DotNet.invokeMethodAsync("HassyaAllrightCloud", 'pressKeyStaffsChart');
            }
        });
    }
    else if (strLocation == "") {
...
//set zindex
function Setzindex(event, lineid, index) {
