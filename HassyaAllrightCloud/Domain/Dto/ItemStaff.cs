...
namespace HassyaAllrightCloud.Domain.Dto
{
    public class ItemStaff
    {
        ...
        public int KinKyuKbn { get; set; }
        public int KinKyuTblCdSeq { get; set; }
        public string TransferDate { get; set; }
        public int UnkoJKbn { get; set; }
        public string unSyuKoYmd { get; set; }
        public string unKikYmd { get; set; }
        public string unHaiSYmd { get; set; }
        public string unTouYmd { get; set; }
