...
{
    public partial class TkdFutTum
    {
        ...
        public short SortJun { get; set; }
        public int SirSitenCdSeq { get; set; }
        public int SirTanKa { get; set; }
        public short SirSuryo { get; set; }
        public int SirGakKin { get; set; }
        public byte SirZeiKbn { get; set; }
        public decimal SirZeiritsu { get; set; }
        public int SirSyaRyoSyo { get; set; }
        public byte SiyoKbn { get; set; }
        public string UpdYmd { get; set; }
        public string UpdTime { get; set; }
        public int UpdSyainCd { get; set; }
        public string UpdPrgId { get; set; }
        public int SireCdSeq { get; set; }
    }
}